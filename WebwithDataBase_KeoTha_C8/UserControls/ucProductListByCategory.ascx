...
<asp:EntityDataSource ID="ProductListByCategoryEntityDataSource" runat="server" ConnectionString="name=MyShopEntities2" DefaultContainerName="MyShopEntities2" EnableFlattening="False" EntitySetName="Products" EntityTypeFilter="Product" Include="Category" Where="it.Category.id = @Category_Id">
    <WhereParameters>
