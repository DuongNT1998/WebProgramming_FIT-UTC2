...
<p>
    &nbsp;</p>
Price:<asp:TextBox ID="txtLowerPrice" runat="server"></asp:TextBox> - <asp:TextBox ID="txtUpperPrice" runat="server"></asp:TextBox>
...
<asp:EntityDataSource ID="SearchEntityDataSource" runat="server" ConnectionString="name=MyShopEntities2" DefaultContainerName="MyShopEntities2" EnableFlattening="False" EntitySetName="Products" EntityTypeFilter="Product" Where="it.Name like '%'+@Name+'%' and it.Price >= @LowerPrice and it.Price <= @UpperPrice">
    <WhereParameters>
